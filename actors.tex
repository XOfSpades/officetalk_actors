...
\begin{frame}
\frametitle{Actors in Elixir}
\includegraphics[width=1.2\linewidth]{./images/hello_elixir.jpg}
\end{frame}
...
\begin{frame}
\frametitle{Actors in Elixir}
\includegraphics[width=1.2\linewidth]{./images/elixir_hello_kira.jpg}
\end{frame}


\begin{frame}
\frametitle{Actors in Elixir}
\includegraphics[width=1.15\linewidth]{./images/elixir_state.png}
\end{frame}
...
\begin{frame}
\frametitle{Actors in Elixir}
\includegraphics[width=0.6\linewidth]{./images/GenServerCode.jpg}
\end{frame}
...
\begin{frame}
\frametitle{Actors in Elixir}
\includegraphics[width=1.25\linewidth]{./images/GenServerTerminal.jpg}
\end{frame}
